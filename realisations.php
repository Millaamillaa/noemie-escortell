...
?> 
<div> 
    <p class="realtitle"> RÉALISATIONS </p>
    <!-- image banderole -->
    <img class="align" src="img/prestation-soulignage-titre.png" alt="banderole"> 
<div>
<div class="container sizereal">
    <div class="annuletablerow row">
        ...
        foreach($realisations as $real){
        	...
        	echo '<div class="realcolumn col-xs-12 col-sm-6 col-md-4 col-lg-4">';
